...
export default function App() {
  ...
  async function ai(sys, usr) {
    const r = await fetch("/api/claude", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ model: "claude-sonnet-4-20250514", max_tokens: 1000, system: sys + " NEVER use XML tags, citation tags, or any <tags> in your response. Output plain text only inside JSON values.", messages: [{ role: "user", content: usr }], tools: [{ type: "web_search_20250305", name: "web_search" }] }) });
